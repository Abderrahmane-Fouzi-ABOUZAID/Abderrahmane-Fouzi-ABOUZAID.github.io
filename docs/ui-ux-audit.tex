...
Image declarations & All 17 declarations checked against actual dimensions and nonempty alternatives. \\
...
Axe marks the controls relationship of unopened image dialogs as needing review. The referenced dialog is created before its launcher is enhanced, has the matching unique ID, and opens successfully from all nine launch points. The open-dialog scan has no such unresolved reference. This is a verified hidden-target relationship, not a missing ID.
